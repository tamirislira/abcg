...
void OpenGLWindow::initializeGL() {
  ...
  // Load model
  loadModelFromFile(getAssetsPath() + "pinetree.obj");
...
void OpenGLWindow::paintGL() {
  ...
  std::uniform_int_distribution<int> red(40,75);
  std::uniform_int_distribution<int> green(45,90);
...
void OpenGLWindow::paintUI() {
  ...
  // Our own ImGui widgets go below
  {
    ...
    // Slider from 0.5f to 2.5f

    ImGui::SliderFloat("Top View", &topView, 0.5f, 2.5f);
